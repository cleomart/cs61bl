...
public class GraphBuildingHandler extends DefaultHandler {
    ...
    private ArrayList<Long> nodeList = new ArrayList<>();
    ...
    public void startElement(String uri, String localName, String qName, Attributes attributes)
        ...
        if (qName.equals("node")) {
            ...
            Vertex newNode = new Vertex(lon, lat, id, GraphDB.projectToX(lon, lat),
                    GraphDB.projectToY(lon, lat));
            g.addVertex(newNode);
            lastVertex = newNode;
            ...
            lastVertex.name = attributes.getValue("v");
        ...
        if (qName.equals("way")) {
            ...
            if (flag) {
                for (int i = 1; i < nodeList.size(); i++) {
                    g.addEdge(nodeList.get(i - 1), nodeList.get(i), wayName);
                }
            }
